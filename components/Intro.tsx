...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Anas Bilal.</span> I'm a{" "}
        <span className="font-bold">Software Engineer</span> with{" "}
        <span className="font-bold">3 years</span> of experience. I enjoy
        building <span className="italic">website & apps</span>. I am a{" "}
        <span className="underline"> MERN/MEAN Developer</span>.
      </motion.h1>
