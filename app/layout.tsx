    ...
    <html lang="en" className="!scroll-smooth">
      ...
      >
        <ActiveSectionContextProvider>
          <ThemeSwitchContext>
            <div className="dark:bg-[#49243E] bg-[#c3f3f7] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] "></div>
            <div className="bg-[#f4e0ed] dark:bg-[#773446] absolute top-[-1rem] -z-10 left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] "></div>
            <Header />
            {children}
            <Footer />
